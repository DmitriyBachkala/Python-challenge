PyBank
-
When in came to the input path and output path i use chat.openai.com to assit me in specifying the correct file paths

script_dir = os.path.dirname(__file__)
input_file_path = os.path.join(script_dir, "Resources/budget_data.csv")
output_file_path = os.path.join(script_dir, "Analysis/financial_analysis.txt")
-
